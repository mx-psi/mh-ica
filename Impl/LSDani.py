...
class LocalSearch:
    '''
    This class implements the interface of each LS method
    '''
    ...
    def getInitParameters(self,delta):
        '''
        Allow to return a options hashkey with all the important parameters
    ...
    def improve(self,sol,fitness,maxeval,options):
        ...
        delta -- range off the initial search
        fitness -- final fitness of the solution
        maxeval -- maximum evaluation number
        options -- options resulting of getInitParameters or previous improve operation
        '''
    #raise BaseException("Not defined LS::improve")

class SolisWets(LocalSearch):
    '''
    This class implements the Solit Wet algorithm
    '''
    maxSuccess = 5
    maxFailed = 3
    ...
    def improve(self,sol,fitness,maxeval,options):
        ...
        sol -- nuarray with the solution to improve
